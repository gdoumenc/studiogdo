...
public class XmlWriter extends Writer {
	 ...
	 *          tag's name.
	 * @param indent
	 *          <tt>true</tt> if tag closed is indented (not the case for CDATA).
	 * @throws IOException
	 */
	...
	/**
	 * Writes text in a CDATA section. The text included may be an XML content, so
	 * if text written contains a ]] it will be replaced by <]>.
	 */
	...
	/**
	 * @param newLine
	 *          <tt>true</tt> if a new line should be added after the closed tag.

...
public class CommandContext<C extends _StencilContext, S extends _PStencil<C, S>> extends Properties {
	...
	public static final String[] PARAMS = new String[] { PARAM(1), PARAM(2), PARAM(3), PARAM(4), PARAM(5), PARAM(6), PARAM(7), PARAM(8), PARAM(9), PARAM(10), PARAM(11), PARAM(12), PARAM(13), PARAM(14), PARAM(15), PARAM(16), PARAM(17), PARAM(18), PARAM(19), PARAM(20) };

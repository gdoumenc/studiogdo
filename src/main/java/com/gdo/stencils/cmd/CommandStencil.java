...
public abstract class CommandStencil<C extends _StencilContext, S extends _PStencil<C, S>> extends _Stencil<C, S> {
    ...
    /**
     * Searches for indexed parameter. Searches first in command context and
     * then in template descriptor. <b>Beware</b> : index starts from 1. (starts
     * from 0 in declaration)
     * 
    ...
    /**
     * This method implements the code checked before the command is executed.
     * In case the status returned is not success, the command is not performed.
     */

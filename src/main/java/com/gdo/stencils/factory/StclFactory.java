...
import com.gdo.stencils.plug.PPropStcl;
...
public class StclFactory extends InterpretedStencilFactory<StclContext, PStcl> {
	...
	private static final Class<? extends PStcl> DEFAULT_PPROPERTY_STENCIL_CLASS = PPropStcl.class;
	private static final String STENCIL_DEFAULT_TEMPLATE_NAME = Stcl.class.getName();
	private static final String PROPERTY_DEFAULT_TEMPLATE_NAME = PropStcl.class.getName();
	...
	@Override
	public Class<? extends PStcl> getDefaultPPropertyStencilClass(StclContext stclContext) {
		return DEFAULT_PPROPERTY_STENCIL_CLASS;
	}

...
public abstract class PathUtils {
	 ...
	 * @param path
	 *          the path to check.
	 * @return <tt>true</tt> if a path is a composed path (contains '/' but not in
	 *         key or expression part).
	 */
	 ...
	 * </p>
	 * 
	 * @return the first name is the composed path or empty string if the path is
	 *         not composed.
	 */
	 ...
	 * </p>
	 * 
	 * @return the first names is the composed path or the path itself if the path
	 *         is not composed.
	 */
	 ...
	 * <p>
	 * A multi contained stencil is determined uniquely by its key in the list of
	 * plugged stencils.
	 * </p>
	 * 
	...
	/**
	 * Tests if this name describes multi contained stencils. Such a name has the
	 * form : <tt>container[exp (, exp)*]</tt> where <tt>exp</tt> is in the form
	 * <tt>prop op value</tt> (<tt>op</tt> may be <tt>==</tt> or <tt>!=</tt>).
	 * <p>
	...
	/**
	 * Returns the value that the stencil's property must be equal to determine a
	 * contained stencil.
	 * 
	 * @param path
	 *          a simple stencil name, not a path with '/'.

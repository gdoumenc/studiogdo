...
public class StencilUtils {
    ...
    /**
     * Creates a stencil iterator made of one single stencil plugged in a slot.
     * If stencil is <tt>null</tt> returns empty iterator.
     * 
     * @param stclContext
     *            the stencil context.
     * @param stencil
     ...
     *         <tt>null</tt> return empty iterator. If condition is
     *         <tt>null</tt> return an iterator on list.
     */
    // /// DEPRECATD
    ...
    /**
     * Sorts the specified stencil iterator according to the order induced by
